export default function Product() {
  const product = [
    {
      ...
      ProductImage: "http://loremflickr.com/640/500/food",
      ProductPrice: "491.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/501/food",
      ProductPrice: "20.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/482/food",
      ProductPrice: "514.00",
      ProductDescription:
        "The automobile layout consists of a front-engine design, with transaxle-type transmissions mounted at the rear of the engine and four wheel drive",
      id: "3"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/483/food",
      ProductPrice: "456.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/484/food",
      ProductPrice: "871.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/485/food",
      ProductPrice: "705.00",
      ProductDescription:
        "The automobile layout consists of a front-engine design, with transaxle-type transmissions mounted at the rear of the engine and four wheel drive",
      id: "6"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/512/food",
      ProductPrice: "823.00",
      ProductDescription:
        "Carbonite web goalkeeper gloves are ergonomically designed to give easy fit",
      id: "7"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/487/food",
      ProductPrice: "424.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/488/food",
      ProductPrice: "33.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/489/food",
      ProductPrice: "847.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/490/food",
      ProductPrice: "266.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/491/food",
      ProductPrice: "61.00",
      ProductDescription:
        "Ergonomic executive chair upholstered in bonded black leather and PVC padded seat and back for all-day comfort and support",
      id: "12"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/492/food",
      ProductPrice: "547.00",
      ProductDescription:
        "Ergonomic executive chair upholstered in bonded black leather and PVC padded seat and back for all-day comfort and support",
      id: "13"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/493/food",
      ProductPrice: "295.00",
      ProductDescription:
        "The automobile layout consists of a front-engine design, with transaxle-type transmissions mounted at the rear of the engine and four wheel drive",
      id: "14"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/494/food",
      ProductPrice: "941.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/495/food",
      ProductPrice: "725.00",
      ProductDescription:
        "The beautiful range of Apple Naturalé that has an exciting mix of natural ingredients. With the Goodness of 100% Natural Ingredients",
      id: "16"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/496/food",
      ProductPrice: "687.00",
      ProductDescription:
        "Ergonomic executive chair upholstered in bonded black leather and PVC padded seat and back for all-day comfort and support",
      id: "17"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/497/food",
      ProductPrice: "934.00",
      ProductDescription:
        "The Football Is Good For Training And Recreational Purposes",
      id: "18"
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/498/food",
      ProductPrice: "56.00",
      ProductDescription:
    ...
    },
    {
      ...
      ProductImage: "http://loremflickr.com/640/499/food",
      ProductPrice: "813.00",
      ProductDescription:
        "Andy shoes are designed to keeping in mind durability as well as trends, the most stylish range of shoes & sandals",
      id: "20"
  ...
  return (
    <div class="row pt-5" style={{ paddingLeft: "10%", paddingRight: "10%" }}>
      {product.map((i) => (
        <div class="col-md-3 text-center">
          <div class="card">
            <img class="card-img-top" alt="img loaging" src={i.ProductImage} />
            <div class="card-body">
              <h5 class="card-title">{i.ProductName}</h5>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">{i.createdAt}</li>
              <li class="list-group-item">{i.ProductPrice}</li>
              <li class="list-group-item">{i.id}</li>
              <li class="list-group-item">{i.ProductDescription}</li>
            </ul>
          </div>
          <br></br>
        </div>
